...
class UnitBuildButton(Button):
    ...
    def __init__(self, x, y, unitinfo):
        ...
        Button.__init__(self, x, y, Constants.UNIT_BUTTON_WIDTH, Constants.UNIT_BUTTON_HEIGHT, self.command, self.unitname)


    def displaybutton(self, window):
        pygame.draw.rect(window.SURFACE, Colors.colorlist['black'], self.buttonrect, 2)
        window.displayText(self.text, self.buttonrect.centerx, self.buttonrect.centery, 25, True)
